...
def get_latest_train_data(country='all'):
    """
    load the data used in the latest training
    """

    data_file = os.path.join("models", country + '-' + 'latest-train.pickle')
...
if __name__ == "__main__":
    ...
    for country in ['all', 'united_kingdom']:
        ## get latest training data
        data = get_latest_train_data(country)
        y = data['y']
        X = data['X']
